...
import org.firstinspires.ftc.team8109_Rise.Sensors.Odometry.TenacityDriveConstants;

public class TenacityChassis extends MecanumDriveTrain {
...
//                OdometryType.TWO_WHEEL_ODO, new Tenacity_OdometryLocalizer(hardwareMap), hardwareMap);
        super(names, new TenacityDriveConstants(),
                OdometryType.DRIVE_ENCODERS, hardwareMap);
