...
//@Autonomous
public class OnePlusSeven_CycleAutonPID extends LinearOpMode {
...
//                targetPose.set(54.888, -8.772, -0.638);
                targetPose.set(2.135, 56.2, 0.9531); //2.175, 56.2, 0.9531
...
//                pipeline.Telemetry();
                if ((claw.getPositionDegrees() > 140) && runtime.seconds() > 0.1){
                    autonState = AutonState.CYCLE_LEFT;
                    runtime.reset();
            ...
            case CYCLE_LEFT:
                switch (cycleState){
                    case TO_CONE_STACK:
                        ...
                        targetPose.set(-25.4, 48.65, 0.14); //-25.4, 48.65, 0.14
...
//                        }
                ...
                if (/*(globalTime.seconds() > 28) ||*/ cycleCounter > 5){
                    autonState = AutonState.TRAVERSE;
                }
                break;
            case TRAVERSE:
                chassis.TranslationalPID_X.setPIDCoefficients(0.25, 0.0375, 0, 0.006);//0.03 0.001
                ...
                targetPose.set(45, 48.65, 1.71); //-25.4, 48.65, 0.14
                ...
                if (withinPoseTolerance()){
                    cycleState = CycleState.TO_CONE_STACK;
                    autonState = AutonState.CYCLE_RIGHT;
            ...
            case CYCLE_RIGHT:
                switch (cycleState){
                    case TO_CONE_STACK:
                        ...
                        chassis.TranslationalPID_Y.setPIDCoefficients(0.25, 0.0375, 0, 0.0015);
                        chassis.HeadingPID.setPIDCoefficients(2.5, 0.03, 0, 0.0015);
                        targetPose.set(69, 48.65, 1.71); //-25.4, 48.65, 0.14
...
//                            translationalTolerance = 1;
                        ...
                        break;
                    case TO_HIGH_JUNCTION:
                        targetPose.set(42.7, 56.2, 2.52); //2.175, 56.2, 0.9531
                        chassis.goToPosePID(targetPose);
...
//                        }
                ...
                if ((globalTime.seconds() > 28.5) || cycleCounter > 7){
            ...
            case PARK:
                ...
                switch (parkingStep){
                    ...
                    case STEP_THREE:
                        switch (parkingZone){
                            case LEFT:
                                targetPose.set(30, 50.5, Math.toRadians(101));
                                break;
                            case MIDDLE:
                                targetPose.set(52, 51, Math.toRadians(101));

                                break;
                            case RIGHT:
                                targetPose.set(72, 51, Math.toRadians(101));
                                break;
                        }
