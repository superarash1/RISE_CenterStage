...
//@Autonomous
public class New_Saved_CycleAutonPID_StrafeStart extends LinearOpMode {
    ...
    public void autonLeftRed(){
        switch (autonState){
            case PUSH_CONE:
                ...
                targetPose.set(-4, 48, Math.toRadians(2));
...
//                targetPose.set(54.888, -8.772, -0.638);
                targetPose.set(2.75, 56.2, 0.9531); //2.175, 56.2, 0.9531
            ...
            case CYCLE:
                switch (cycleState){
                    case TO_CONE_STACK:
                        ...
                        targetPose.set(-25.35, 49.3, 0.14); //-25.4, 48.65, 0.14
