...
//@Autonomous
public class Red_CycleAuton_CV_Align extends LinearOpMode {
...
//                wrist.wristPosition = Wrist.WristPosition.OUTTAKE_POSITION;
                ...
                if (withinPoseTolerance()){
                    ...
                    chassis.TranslationalPID_X.setPIDCoefficients(0.35, 0.035, 0, 0.0025);//0.03 0.001
                    chassis.TranslationalPID_Y.setPIDCoefficients(0.35, 0.035, 0, 0.003);
...
//                    chassis.trackingObject = Chassis.TrackingObject.JUNCTION;
            ...
            case JAM_CONE:
                ...
                if (Math.abs(slides.slidesPID.error) < slides.slidesPID.tolerance){
...
//                }
            ...
            case CYCLE:
                switch (cycleState){
                    case TO_CONE_STACK:
                        chassis.TranslationalPID_X.setPIDCoefficients(0.25, 0.03, 0, 0.001);//0.03 0.001
                        chassis.TranslationalPID_Y.setPIDCoefficients(0.2, 0.035, 0.1, 0);
                        chassis.HeadingPID.setPIDCoefficients(2.5, 0.03, 0.2, 0.002);
                        targetPose.set(51.9, 24.7, -1.59);
...
//                        chassis.visionAlign(new Vector2D(100, 160), pipeline);
                    ...
                    case BOOST_UP:
                        ...
                        if (runtime.seconds() > 0.75) {
                            chassis.TranslationalPID_X.setPIDCoefficients(0.2, 0.035, 0, 0.001);//0.03 0.001
                            chassis.TranslationalPID_Y.setPIDCoefficients(0.25, 0.02, 0, 0.001);
                            chassis.HeadingPID.setPIDCoefficients(0.15, 0.04, 0, 0.001); // 0.03 0.1 0.001
...
//                            cycleState = CycleState.SCORE_CONE;
                            cycleState = CycleState.JAM_CONE;
                            slides.slidesState = ViperSlides.SlidesState.HIGH_DUNK;
                    ...
                    case JAM_CONE:
                        ...
                        break;
                    case SCORE_CONE:
//                        chassis.visionAlign(new Vector2D(209, 143), pipeline);
//                        targetPose.set(54.775, -5.77,-0.58);
//                        targetPose.set(51.75, -5.7, -0.6362);
                        //TODO: Fix this shit to match old
                ...
                //TODO: Autopark
                if ((globalTime.seconds() > 28) || cycleCounter > 4){
